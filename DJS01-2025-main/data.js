...
export const podcasts = [
  ...
  },
  {
    ...
    description:
      "The Cold War, Prohibition, the Gold Rush, the Space Race. Every part of your life - the words you speak, the ideas you share - can be traced to our history, but how well do you really know the stories that made America? Hosted by Lindsay Graham (not the Senator).",
    seasons: 51,
    image:
  ...
  },
  {
    ...
    title: "Scamfluencers",
    description:
      "You never really know someone…especially online. These are the stories of the world’s most insidious Scamfluencers. Co-hosts Scaachi Koul and Sarah Hagi unpack epic stories of deception.",
    seasons: 3,
    image:
  ...
  },
  {
    ...
    title: "Killer Psyche",
    description:
      "When a shocking crime occurs, people ask “Why?” Retired FBI agent Candice DeLong draws on her decades of experience to reveal why murderers and criminals committed these acts.",
    seasons: 2,
    image:
  ...
  },
  {
    ...
    title: "Even the Rich",
    description:
      "Our lives can be crazy, but you can take a break from it all with Wondery’s Even the Rich, where co-hosts Brooke Siffrinn and Aricia Skidmore-Williams tell stories about some of the greatest family dynasties in history.",
    seasons: 33,
    image:
  ...
  },
  {
    ...
    description:
      "In this immersive series from Wondery, host-adventurers share thrilling stories of survival. From a soccer team trapped in a cave to a woman taken hostage by Somali pirates.",
    seasons: 19,
    image:
  ...
  },
  {
    ...
    description:
      "Each episode tackles a different disease, from its history to its biology. Ecologists and epidemiologists Erin Welsh and Erin Allmann Updyke make infectious diseases acceptable fodder for dinner.",
    seasons: 5,
    image:
  ...
  },
  {
    ...
    description:
      "British scandals change the course of history. From the creators of Business Wars, American Scandal and Even The Rich, we tell stories of the murkier side of the British elite.",
    seasons: 19,
    image:
  ...
  },
  {
    ...
    description:
      "Everywhere around us are echoes of the past. Host Patrick Wyman, PhD helps us understand our world and how it got to be the way it is.",
    seasons: 5,
    image:
